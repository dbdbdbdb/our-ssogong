...
public class Display_mybook extends JFrame{
	GridBagLayout gbl;
	...
	public Display_mybook(){
		...
		add(new JLabel("Display_mybook", JLabel.CENTER),0,2,6,1,1,1);
	...
	public static void main(String args[]){
		Display_mybook f = new Display_mybook();
		f.setTitle("Gridd");
		f.setVisible(true);
		f.setSize(1000, 850);
